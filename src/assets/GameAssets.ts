...
const assets = [
    ...
    { alias: "rankingTitleJp", src: `${rankingImgPath}title_jp.png` },
    { alias: "rankingTitleCn", src: `${rankingImgPath}title_cn.png` },
    { alias: "rankingTitleTw", src: `${rankingImgPath}title_tw.png` },
